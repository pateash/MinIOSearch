...
mc admin config set myminio notify_amqp:1 exchange="$EXCHANGE" exchange_type="direct" routing_key="minio" url="$URL" queue_dir="" queue_limit="0" auto_deleted="false" delivery_mode="2"
